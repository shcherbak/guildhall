...
CREATE OR REPLACE FUNCTION tests.__production__destroy()
  RETURNS void AS
$BODY$
DECLARE
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION tests.__production__destroy()
  OWNER TO postgres;
...
CREATE OR REPLACE FUNCTION tests.__production__get_gid_by_id()
  RETURNS void AS
$BODY$
DECLARE
  _test_id CONSTANT bigint := 202;
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION tests.__production__get_gid_by_id()
  OWNER TO postgres;



CREATE OR REPLACE FUNCTION tests.__production__get_head()
  RETURNS void AS
$BODY$
DECLARE
  _head common.production_head;
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION tests.__production__get_head()
  OWNER TO postgres;




CREATE OR REPLACE FUNCTION tests.__production__get_id_by_gid()
  RETURNS void AS
$BODY$
DECLARE
  _test_id CONSTANT bigint := 202;
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION tests.__production__get_id_by_gid()
  OWNER TO postgres;



CREATE OR REPLACE FUNCTION tests.__production__init()
  RETURNS void AS
$BODY$
DECLARE
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION tests.__production__init()
  OWNER TO postgres;



CREATE OR REPLACE FUNCTION tests.__production__reinit()
  RETURNS void AS
$BODY$
DECLARE
  _test_head CONSTANT common.production_head[] := ARRAY[
...
$BODY$
  LANGUAGE plpgsql VOLATILE
  COST 100;
ALTER FUNCTION tests.__production__reinit()
  OWNER TO postgres;